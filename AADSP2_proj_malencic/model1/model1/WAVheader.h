...
struct WAV_HEADER
{
	struct WAV_HEADER_RIFF		riff;
	struct WAV_HEADER_FMT		fmt;
	struct WAV_HEADER_DATA		data;
	long				HeaderSize;
};

int ReadWavHeader(FILE *refFile,struct  WAV_HEADER  &inWAVhdr);
int WriteWavHeader(FILE *refFile, struct WAV_HEADER  &inWAVhdr);
